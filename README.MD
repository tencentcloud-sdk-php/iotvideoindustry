...
1. PHP 5.6.0 版本及以上
2. 从腾讯云控制台 开通相应产品
3. 获取 SecretID、SecretKey 以及调用地址（endpoint），endpoint 为 iotvideoindustry.tencentcloudapi.com，具体参考各产品说明。
...
3. 执行命令 `composer require tencentcloud/iotvideoindustry` 添加依赖。
